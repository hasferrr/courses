...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname weather-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require racket/file)
...
(define (total-warm-rain low)
  (local [(define (rainfall w) (weather-rain w))
          (define (>15c-temp w) (> (weather-avg-tmp w) 15))]
    (foldr + 0 (map rainfall (filter >15c-temp low)))))
