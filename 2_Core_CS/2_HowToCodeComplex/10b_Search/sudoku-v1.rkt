...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname sudoku-v1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
