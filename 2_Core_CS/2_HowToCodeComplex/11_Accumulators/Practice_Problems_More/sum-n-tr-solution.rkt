...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname sum-n-tr-solution) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
