...
; 
; Use local to encapsulate the functions so that:
; - total-area-dir,
; - total-area--lod,
; - total-area--loi, and
; - image-area
; are private to a new function called "total-area".
;
; Be sure to revise the:
; - signature,
; - purpose,
; - tests etc.
;_________________________________________________________________________________
...
(check-expect (total-area (make-dir "D0" empty empty)) 0)
