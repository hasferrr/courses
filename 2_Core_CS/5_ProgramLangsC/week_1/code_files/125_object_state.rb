...
=begin
  ------------NOTES------------
  No, you cannot call a class method like `reset_bar` on an instance of the
  C class (class that defined above) in Ruby. Class methods are defined on the class
  itself, and are not associated with any particular instance of the class.

  If you want to define a method that can be called on instances of the
  C class, you would define an instance method instead.
=end
