...
*)
datatype geom_exp =
       NoPoints             (* empty set of two-dimensional points *)
...
fun preprocess_prog exp =
    case exp of
        ...
        | Intersect (a, b)   => Intersect (preprocess_prog a, preprocess_prog b)
        | Let (s, a, b)      => Let (s, preprocess_prog a, preprocess_prog b)
        | Shift (dx, dy, e0) => Shift(dx, dy, preprocess_prog e0)
        | _ => exp
